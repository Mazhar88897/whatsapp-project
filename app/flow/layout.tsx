      ...
      */}
      <p className="text-xl font-bold text-green-500">WhatsAPP CRM</p>
          ...
          <div className="flex-1 px-4 pb-3 text-md space-y-4 overflow-y-auto">
            ...
            {/* Analytics section */}
            <Link href="/flow/contact-us" className="flex justify-between font-bold items-center mt-4 px-2 text-sm ">
              <span>Contact Us</span>
              <span className="bg-green-800 text-white text-xs px-1.5 py-0.5 rounded-full">Help</span>
            </Link>
