    ...
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {articles.map((article) => (
         ...
         <Link href="/main/blogs/single-blog" className="mt-auto py-1  inline-flex items-center hover:border-blue-500  text-slate-700 text-sm font-medium border-b border-black">
